...
set_property PACKAGE_PIN J15 [get_ports {A[5]}]
set_property PACKAGE_PIN L16 [get_ports {A[4]}]
set_property PACKAGE_PIN M13 [get_ports {A[3]}]
set_property PACKAGE_PIN R15 [get_ports {A[2]}]
set_property PACKAGE_PIN R17 [get_ports {A[1]}]
set_property PACKAGE_PIN T18 [get_ports {A[0]}]
set_property PACKAGE_PIN U18 [get_ports {B[5]}]
